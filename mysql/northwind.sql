...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 23 2023 г., 14:04
...
--
-- Структура таблицы `employee_privileges`
--
...
--
-- Дамп данных таблицы `employee_privileges`
--
...
--
-- Структура таблицы `inventory_transactions`
--
...
--
-- Дамп данных таблицы `inventory_transactions`
--
...
--
-- Структура таблицы `inventory_transaction_types`
--
...
--
-- Дамп данных таблицы `inventory_transaction_types`
--
...
--
-- Структура таблицы `orders_tax_status`
--
...
--
-- Дамп данных таблицы `orders_tax_status`
--
...
--
-- Структура таблицы `order_details_status`
--
...
--
-- Дамп данных таблицы `order_details_status`
--
...
--
-- Дамп данных таблицы `purchase_orders`
--
...
--
-- Структура таблицы `purchase_order_details`
--
...
--
-- Дамп данных таблицы `purchase_order_details`
--
...
--
-- Структура таблицы `purchase_order_status`
--
...
--
-- Дамп данных таблицы `purchase_order_status`
--
...
--
-- Структура таблицы `sales_reports`
--
...
--
-- Дамп данных таблицы `sales_reports`
--
...
--
-- Индексы таблицы `employee_privileges`
--
...
--
-- Индексы таблицы `inventory_transactions`
--
...
--
-- Индексы таблицы `inventory_transaction_types`
--
...
--
-- Индексы таблицы `orders_tax_status`
--
...
--
-- Индексы таблицы `order_details_status`
--
...
--
-- Индексы таблицы `purchase_orders`
--
...
--
-- Индексы таблицы `purchase_order_details`
--
...
--
-- Индексы таблицы `purchase_order_status`
--
ALTER TABLE `purchase_order_status`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `sales_reports`
--
ALTER TABLE `sales_reports`
  ADD PRIMARY KEY (`group_by`);

--
-- Индексы таблицы `shippers`
--
...
--
-- AUTO_INCREMENT для таблицы `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
...
--
-- AUTO_INCREMENT для таблицы `purchase_orders`
--
ALTER TABLE `purchase_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT для таблицы `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=296;

--
-- AUTO_INCREMENT для таблицы `shippers`
--
ALTER TABLE `shippers`
...
--
-- Ограничения внешнего ключа таблицы `employee_privileges`
--
ALTER TABLE `employee_privileges`
...
--
-- Ограничения внешнего ключа таблицы `inventory_transactions`
--
ALTER TABLE `inventory_transactions`
...
--
-- Ограничения внешнего ключа таблицы `purchase_orders`
--
ALTER TABLE `purchase_orders`
...
--
-- Ограничения внешнего ключа таблицы `purchase_order_details`
--
ALTER TABLE `purchase_order_details`
